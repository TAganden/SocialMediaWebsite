...
$qry=mysql_query("INSERT INTO friends(userName,friend_userName) VALUES ('".$_SESSION['userName']."','$colname_Recordset1')");
$qry2=mysql_query("INSERT INTO friends(friend_userName,userName) VALUES ('".$_SESSION['userName']."','$colname_Recordset1')");
...
<div id="wrapper">   
     ...
     <div id="navigation">
        <ul>
         ...
         <li class="n"><?php echo "You and {$row_Recordset1['firstName']} {$row_Recordset1['lastName']} are now friends"; ?></li>
