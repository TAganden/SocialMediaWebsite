...
$qry=mysql_query("SELECT firstName,userName FROM users WHERE userName IN (SELECT friend_userName FROM friends  WHERE userName='".$_SESSION['userName']."') ");
...
<div id="wrapper">           
     <div id="navigation">
        <ul>
         ...
         <li><a href="messages.php"><img src="message-already-read-icon.png" alt="image" height="40px" width="40px"></a></li>
   ...
   <div id="content">
       ...
       <div id="search_description">
         ...
         <a href="compose_message.php?userName=<?php echo $result['userName']; ?>"><img src="message-already-read-icon.png" alt="image" height="20px" width="20px"></a>
         <p>----------------------------------</p>
       </div>
